...
public class TProductHome {
	...
	public TProduct findById(int id) {
		...
		try {
			TProduct instance = (TProduct) sessionFactory.getCurrentSession().get("com.yzc.entity.TProduct", id);
			if (instance == null) {
	...
	public List findByExample(TProduct instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.yzc.entity.TProduct").add(Example.create(instance))
					.list();
	...
	public List findByExample(int begin, int rows) {
		...
		try {
			Criteria criteria = sessionFactory.getCurrentSession().createCriteria("com.yzc.entity.TProduct");
